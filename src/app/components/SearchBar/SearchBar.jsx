...
const SearchBar = ({ bg, mt, w, border, placeholder }) => {
    return (
        <>

            <form className={`sm-max:w-fit `} action="">

                <div className={`relative ${w} h-[55px] ${mt}  border-[#DEE1E5] ${border && "border-2"} 	 text  text md-max:w-10 md-max:h-10 flex items-center  p-4 justify-between rounded-lg search-input ${bg}`}>
