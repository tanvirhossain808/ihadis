        ...
        <div className="header flex items-center justify-between  p-6 px-4">
            ...
            <div className="searchSection mr-3  items-center flex items-center justify-between  w-96  md-max:gap-4 lg-min:gap-20 2xl-min:gap-5">
                <form className="sm-max:w-fit" action="">
                    ...
                    <div className="relative w-[270px] h-[55px] rounded-xl  border-[#DEE1E5] border-2 	 text border dark:border-dark-cat-border dark:text-hadith-deepoffwhite text md-max:w-10 md-max:h-10 flex items-center  p-4 justify-between rounded-lg search-input">
                        ...
                        <div className="input">
                            <input type="text" placeholder="Search Hadith" className="md-max:hidden  dark:bg-hadith-dark-card text-hadith-offblack   p-3 rounded-lg focus:outline-0 focus:text-black   " />
