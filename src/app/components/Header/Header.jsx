        ...
        <div className="header">
            <div className="logo flex items-center cursor-pointer">
                ...
                <div className="description ml-6 block md-max:hidden">
                    ...
                    <h6 className="text-xl font-bold text-black dark:text-hadith-deepoffwhite ">
                        হাদিস পড়ুন শিখুন এবং জানুন

                    </h6>
                </div>
            </div>
            <div className="searchSection flex items-center justify-end md-max:gap-4 lg-min:gap-20 2xl-min:gap-5">
                <form className="sm-max:w-fit" action="">
                    ...
                    <div className="relative bg-[#ECEEF0] dark:bg-[#383838] md-max:w-10 md-max:h-10 flex items-center justify-center rounded-lg search-input">
                        <div className="md-max:block">
                            <svg className="fill-[#5C5C5C] dark:bg-[#383838] dark:fill-white lg-min:absolute  top-[1.1rem]" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
